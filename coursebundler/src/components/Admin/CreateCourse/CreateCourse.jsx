...
const CreateCourse = () => {
  ...
  return (
    ...
    <Select focusBorderColor='purple.300' value={category} onChange={ e => setCategoty(e.target.value)} >
    ...
    <Input accept='image/*' required type={'file'} focusBorderColor='purple.300' css={{'&::file-selector-button':{...fileUploadCss, color:'purple'},
